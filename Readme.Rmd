...
Model performance on training dataset based on `log loss` metric:

```{r}
models_performace_train
```

Model performance on validation dataset based on `log loss` metric:
```{r}
