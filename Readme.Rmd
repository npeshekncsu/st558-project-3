...
In order to obtain `log loss` metric for train and validation datasets, let's create custom function for log loss calculation.
...
logistic_regression_train[['logistic_regression_model_1']] = log_loss_train_lr_model_1
```
...
logistic_regression_train[['logistic_regression_model_2']] = log_loss_train_lr_model_2
```
...
logistic_regression_train[['logistic_regression_model_3']] = log_loss_train_lr_model_3
```
...
Now we can choose the best performed model based on train data performance among logistic regression models.
...
logistic_regression_train[['logistic_regression_model']] = logistic_regression_train[[best_lr_model]]
...
print(paste("Log Loss:", log_loss_val_lr_model))
